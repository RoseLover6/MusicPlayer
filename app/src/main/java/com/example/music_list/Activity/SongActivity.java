...
public class SongActivity extends AppCompatActivity implements View.OnClickListener {
    public String[] musicName = {"龙拳", "夜曲", "爱在西元前", "告白气球"};
    public static int[] icons = {R.drawable.jay1, R.drawable.jay2, R.drawable.jay3, R.drawable.jay4};
    //进度条
    private static SeekBar sb;
    private static TextView tv_progress, tv_total, name_song;
    //动画
    private ObjectAnimator animator;
    private SongService.MusicControl musicControl;
    private String name;
    ...
    private void init() {
        ...
        intent2 = new Intent(this, SongService.class);
        ...
        iv_music.setImageResource(FragThree.icons[i]);
    ...
    class MyServiceConn implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            musicControl = (SongService.MusicControl) service;
        }
