...
import com.example.music_list.Service.SearchService;
...
public class SearchActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private SearchService.MusicControl musicControl;
    private String name;
    ...
    private void init() {
        ...
        name = intent1.getStringExtra("music");
        name_song.setText(name);
        //创建一个意图对象，是从当前的Activity跳转到Service
        intent2 = new Intent(this, SearchService.class);
    ...
    class MyServiceConn implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            musicControl = (SearchService.MusicControl) service;
        }
