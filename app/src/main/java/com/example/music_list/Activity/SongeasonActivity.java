...
public class SongeasonActivity extends AppCompatActivity implements View.OnClickListener {
    public String[] musicName = {"十年", "淘汰", "爱情转移", "孤勇者"};
    ...
    private SongeasonService.MusicControl musicControl;
    private String name;
    ...
    private void init() {
        ...
        intent2 = new Intent(this, SongeasonService.class);
    ...
    class MyServiceConn implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            musicControl = (SongeasonService.MusicControl) service;
        }
