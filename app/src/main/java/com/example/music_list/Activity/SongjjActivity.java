...
import com.example.music_list.Service.SongjjService;
...
public class SongjjActivity extends AppCompatActivity implements View.OnClickListener {
    public String[] musicName = {"Always Online", "修炼爱情", "爱笑的眼睛", "江南"};
    ...
    private SongjjService.MusicControl musicControl;
    private String name;
    ...
    private void init() {
        ...
        intent2 = new Intent(this, SongjjService.class);
        ...
        iv_music.setImageResource(FragFour.icons[i]);
    ...
    class MyServiceConn implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            musicControl = (SongjjService.MusicControl) service;
        }
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_pre://播放上一首
                if ((i + change) < 1) {
                    ...
                    imageView.setImageResource(icons[i + change]);
            ...
            case R.id.btn_pause://暂停按钮点击事件
                ...
                findViewById(R.id.btn_continue_play).setVisibility(View.VISIBLE);
                musicControl.pausePlay();
                animator.pause();
                break;
            case R.id.btn_continue_play:
                findViewById(R.id.btn_continue_play).setVisibility(View.INVISIBLE);
                findViewById(R.id.btn_pause).setVisibility(View.VISIBLE);
