...
//这是一个Service服务类
public class SongeasonService extends Service {
    //声明一个MediaPlayer引用
    private MediaPlayer player;
    //声明一个计时器引用
    private Timer timer;
    //构造函数
    public SongeasonService() {}
    @Override
        ...
        if(timer==null){
            ...
            TimerTask task=new TimerTask() {
                ...
                public void run() {
                    ...
                    Message msg= SongeasonActivity.handler.obtainMessage();//创建消息对象
    ...
    public class MusicControl extends Binder{
        public void play(int i){//String path
            Uri uri=Uri.parse("android.resource://"+getPackageName()+"/raw/"+"eason"+i);
            try{
                //重置音乐播放器
                player.reset();
                //加载多媒体文件
        ...
        public void continuePlay(){ player.start();}//继续播放音乐
