...
//这是一个Service服务类
public class SongjjService extends Service {
    //声明一个MediaPlayer引用
    private MediaPlayer player;
    //声明一个计时器引用
    private Timer timer;
    //构造函数
    public SongjjService() {}
    @Override
        ...
        if(timer==null){
            ...
            TimerTask task=new TimerTask() {
                ...
                public void run() {
                    ...
                    Message msg= SongjjActivity.handler.obtainMessage();//创建消息对象
                    ...
                    msg.setData(bundle);
                    //最后将消息发送到主线程的消息队列
                    SongjjActivity.handler.sendMessage(msg);
                }
            };
   ...
   public class MusicControl extends Binder{
        public void play(int i){//String path
            Uri uri=Uri.parse("android.resource://"+getPackageName()+"/raw/"+"jj"+i);
            try{
                //重置音乐播放器
                player.reset();
                //加载多媒体文件
